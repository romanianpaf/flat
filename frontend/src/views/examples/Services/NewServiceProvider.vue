        ...
        <div class="card">
          <div class="pb-0 card-header">
            <div class="d-lg-flex align-items-center">
              <div>
                <h5 class="mb-0">Adaugă furnizor de servicii</h5>
              </div>
          ...
          <div class="card-body">
            ...
            <div class="row mt-3">
              <div class="col-md-4">
                ...
                <select v-model="form.provider_type" class="form-control">
                  <option value="private">Persoană fizică</option>
                  <option value="company">Companie</option>
                </select>
                <validation-error :errors="apiValidationErrors.provider_type" />
              </div>
...
export default {
  ...
  methods: {
    ...
    async loadSubcategories() {
      ...
      this.form.service_subcategory_id = "";
    ...
    async save() {
      ...
      this.loading = true;
      try {
        await this.$store.dispatch("serviceProviders/addProvider", this.form);
