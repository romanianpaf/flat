        ...
        <div class="card">
          <div class="pb-0 card-header">
            <div class="d-lg-flex align-items-center">
              <div>
                <h5 class="mb-0">Adaugă subcategorie de servicii</h5>
              </div>
...
export default {
  ...
  methods: {
    ...
    async addSubcategory() {
      ...
      this.loading = true;
      try {
        await this.$store.dispatch("serviceSubcategories/addSubcategory", this.subcategory);
