    ...
    async reactiveTable() {
      ...
      if (this.rolesList?.length > 0) {
        ...
        this.eventToCall({
          ...
          textDelete: "Rol șters cu succes!",
          textDefaultData: "roles",
          textDeleteError: "Acest rol are utilizatori asociați.",
          params: {
            query: currentQuery,
            perpage: currentPerPage,
            nr: currentPage,
        ...
        this.tableRoles.setMessage("Nu există rezultate pentru căutarea ta");
      }
    },
  },
};
