      ...
      <div class="col-12">
        <div class="card">
            ...
            <div class="d-lg-flex">
              ...
              <div class="my-auto mt-4 ms-auto mt-lg-0">
                <div class="my-auto ms-auto">
                  <router-link to="/users/list" class="mb-0 btn bg-gradient-primary btn-sm"
          ...
          <div class="card-body">
            ...
            <label class="form-label mt-2 row mt-4">Beneficiar (opțional)</label>
            <select 
            ...
            <small class="text-muted mt-2">
              ...
              Lasă "Global" pentru utilizatori cu acces la toate resursele, sau selectează un beneficiar specific.
            </small>
