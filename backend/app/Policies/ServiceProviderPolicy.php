...
class ServiceProviderPolicy
{
    ...
    {
        return $user->can('view service providers');
    }
    ...
    {
        return $user->can('create service providers');
    }
    ...
    {
        return $user->can('edit service providers') || $serviceProvider->created_by === $user->id;
    }
    ...
    {
        return $user->can('delete service providers');
    }
